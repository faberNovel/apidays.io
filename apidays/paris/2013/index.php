...
<head>
	<meta charset="utf-8">
	<title>#APIdays back in 2013</title>
	<meta name="description" content="Apidays">
	<meta name="author" content="">
	<meta name="viewport" content="user-scalable=yes, width=device-width" />
	<meta name="apple-mobile-web-app-capable" content="yes">
	<meta name="keywords" content="API 2013 apidays" />
	...
	<link rel="stylesheet" href="css/2013.css?v=1.0">
...
<?php 
	$url = 'http://apidays.io/paris/?y=2013';
?>
<body>
	<div id="wrapper">
			...
			<section class="section home" id="home">
				<div class="inside fil">
					...
					<div class="sleft">
						...
						<div class="socials">
							<br/>
							<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo $url;?>" data-via="apidays2012" data-related="apidays2012">Tweet</a>
...
<script type="IN/Share" data-url="<?php echo $url;?>" data-counter="right"></script>
							<br/><br/>
							<div class="fb-like" data-send="false" data-href="<?php echo $url;?>" data-layout="button_count" data-width="450" data-show-faces="false"></div>
